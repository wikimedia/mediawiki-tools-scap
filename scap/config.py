...
DEFAULT_CONFIG = {
    ...
    "web_proxy": (str, None),
    # How long scap will wait for a gerrit patch with a version change to complete CI. Default is 10m
    "version_update_patch_timeout": (int, 600),
    ...
    "build_mw_next_container_image": (bool, True),
